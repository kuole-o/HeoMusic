      ...
      return a(e, [{
        ...
        value: function () {
          ...
          if (this.index > this.current.length - 1 || e < this.current[this.index][0] || !this.current[this.index + 1] || e >= this.current[this.index + 1][0])
            for (var t = 0; t < this.current.length; t++) e >= this.current[t][0] && (!this.current[t + 1] || e < this.current[t + 1][0]) && (this.index = t, this.container.getElementsByClassName("aplayer-lrc-current")[0].classList.remove("aplayer-lrc-current"), this.container.getElementsByTagName("p")[t].classList.add("aplayer-lrc-current"), heo.scrollLyric())
        }
      }, {
        key: "switch",
        value: function (e) {
    ...
    e.exports = function (e) {
        ...
        if (a.fixed) {
            appendContent(`
                ...
                <div class="aplayer-list${a.listFolded || heo.isMobileDevice() ? " aplayer-list-hide" : ""}"${a.listMaxHeight ? ` style="max-height: ${o(a.listMaxHeight)}"` : ""}>
